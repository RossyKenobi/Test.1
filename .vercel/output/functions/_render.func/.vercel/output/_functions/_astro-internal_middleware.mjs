...
import "cookie";
import { s as sequence } from "./chunks/index_BB-XzWTu.mjs";
async function createAsyncLocalStorage() {
  const { AsyncLocalStorage } = await import("async_hooks");
  return new AsyncLocalStorage();
}
var authAsyncStorage = await createAsyncLocalStorage();
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_aW1tdW5lLWhhd2stMzUuY2xlcmsuYWNjb3VudHMuZGV2JA", "SITE": void 0, "SSR": true };
...
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_aQBepR8op8eLbMnlGoxVKlynbN2HDyktFhDO8880qk", _: process.env._ })[envVarName] || void 0;
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"3.0.8"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "3.0.8",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_aQBepR8op8eLbMnlGoxVKlynbN2HDyktFhDO8880qk", _: process.env._ }).MODE
  },
  telemetry: {
